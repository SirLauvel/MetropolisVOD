...
<body class="bg-primary">
    ...
    <main class="h-[90vh] mt-[10vh] p-10">
        <div class="bg-antiWhite p-10">
            <div class="flex flex-col items-center">
                <h2 class="text-3xl font-bold">Liste des films</h2>
                    ...
                    <tbody>
                        <?php foreach ($movieTable as $movie) { ?>
                            <tr
                                ...
                                <td class="w-4 p-4">
                                    <div class="flex items-center">
                                        <input id="checkbox-table-search-1" type="checkbox" name="movie" value="<?= $movie['id_movie'] ?>"
                                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    ...
                                    <div class="flex justify-center gap-5">
                                        <div>
                                            <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown"
                                                ...
                                                type="button">Modifier<svg class="w-4 h-4 ml-2" aria-hidden="true"
                                            ...
                                            <div id="dropdown"
                                                ...
                                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                                    ...
                                                    <li>
                                                        <a href="udapteMovie.php?id_movie=<?= $movie['id_movie'] ?>"
                                                            class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Données
                                                            du film</a>
                                                    </li>
                                                    <li>
                                                        <a href="udapteRessource_movie.php?id_movie=<?= $movie['id_movie'] ?>"
                                                            class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Des
                                                            acteurs, réalisateur,...</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div>
                                            <button data-modal-target="alertDelete_<?= $movie['id_movie'] ?>"
                                                data-modal-toggle="alertDelete_<?= $movie['id_movie'] ?>"
                                                class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-1 text-center inline-flex items-center">
                                                Supprimer
                                            </button>
                                        </div>
                            ...
                            <div id="alertDelete_<?= $movie['id_movie'] ?>" tabindex="-1"
                                class="fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] md:h-full">
                                <div class="relative w-full h-full max-w-md md:h-auto">
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        <button type="button"
                                            class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white"
                                            data-modal-hide="alertDelete_<?= $movie['id_movie'] ?>">
                                        ...
                                        <div class="p-6 text-center">
                                            ...
                                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Êtes-vous
                                                sûr de vouloir effacer le film : <span class="font-bold">
                                                    <?= $movie['title_movie'] ?>
                                                </span> ?</h3>
                                            <form action="assets/src/back/deleteMovieTreatment.php" method="post">
                                                <input type="hidden" name="id_movie" value="<?= $movie['id_movie'] ?>" />
                                                <button data-modal-hide="alertDelete_<?= $movie['id_movie'] ?>"
                                                    type="submit"  name="deleteMovie"
                                                    class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                                    Oui, je suis sûr !
                                                </button>
                                            </form>
                                            <button data-modal-hide="alertDelete_<?= $movie['id_movie'] ?>" type="button"
