        ...
        <div class="bg-antiWhite p-10 rounded">
            ...
            <div class="flex items-center justify-between p-10 bg-white dark:bg-gray-900">
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        <?php foreach ($realisatorTable as $realisator) { ?>
                            <tr
                                class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                <td class="w-4 p-4">
                                    <div class="flex items-center">
                                        <input id="checkbox-table-search-1" type="checkbox" name="realisator"
                                            value="<?= $realisator['id_realisator'] ?>"
                                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                ...
                                <th scope="row"
                                    ...
                                    <?= $realisator['name_realisator'] ?>
                                </th>
                                <td class="px-6 py-4">
                                    <div class="flex justify-center gap-5">
                                        <div>
                                            <button data-modal-target="udapteModal_<?= $realisator['id_realisator'] ?>"
                                                data-modal-toggle="udapteModal_<?= $realisator['id_realisator'] ?>"
                                        ...
                                        <div>
                                            <button data-modal-target="alertDelete_<?= $realisator['id_realisator'] ?>"
                                                data-modal-toggle="alertDelete_<?= $realisator['id_realisator'] ?>"
                            ...
                            <div id="udapteModal_<?= $realisator['id_realisator'] ?>" tabindex="-1"
                                class="fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] md:h-full">
                                <div class="relative w-full h-full max-w-md md:h-auto">
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        <button type="button"
                                            class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white"
                                            data-modal-hide="udapteModal_<?= $realisator['id_realisator'] ?>">
                                        ...
                                        <div class="p-6 text-center">
                                            <h3 class="mb-5 text-xl font-bold text-gray-500">Modication de Réalisateur</h3>
                                            <form
                                                action="assets/src/back/updateRealisator.php?id_realisator=<?= $realisator['id_realisator'] ?>"
                                                method="post">
                                                <div class="relative">
                                                    <input type="text" id="name_realisator" name="name_realisator" value="<?= $realisator['name_realisator'] ?>"
                                                ...
                                                <input type="hidden" name="id_realisator" value="<?= $realisator['id_realisator'] ?>" />
                                                <div class="p-6 text-center">
                                                    <button data-modal-hide="udapteModal_<?= $realisator['id_realisator'] ?>"
                                                        type="submit" name="updateRealisator"
                            ...
                            <div id="alertDelete_<?= $realisator['id_realisator'] ?>" tabindex="-1"
                                class="fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] md:h-full">
                                <div class="relative w-full h-full max-w-md md:h-auto">
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        <button type="button"
                                            class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white"
                                            data-modal-hide="alertDelete_<?= $realisator['id_realisator'] ?>">
                                            <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd"
                                                    d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                                        ...
                                        <div class="p-6 text-center">
                                            ...
                                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Êtes-vous
                                                sûr de vouloir effacer le réalisateur : <span class="font-bold">
                                                    <?= $realisator['name_realisator'] ?>
                                                </span> ?</h3>
                                            <form action="assets/src/back/deleteRealisator.php" method="post">
                                                <input type="hidden" name="id_realisator"
                                                    value="<?= $realisator['id_realisator'] ?>" />
                                                <button data-modal-hide="alertDelete_<?= $realisator['id_realisator'] ?>"
                                                    type="submit" name="deleteRealisator"
        ...
        <div id="addModal" tabindex="-1"
            ...
            <div class="relative w-full h-full max-w-md md:h-auto">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-6 text-center">
                        <h3 class="mb-5 text-xl font-bold text-gray-500">Ajout de réalisateur</h3>
                        <form action="assets/src/back/addRealisator.php" method="post">
                            <div class="relative">
                                <input type="text" id="name_realisator"name="name_realisator"
                                    class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-secondary peer"
                                    placeholder=" " />
                                <label for="name_realisator"
                            ...
                            <div class="p-6 text-center">
                                <button data-modal-hide="addModal" type="submit" name="addRealisator"
