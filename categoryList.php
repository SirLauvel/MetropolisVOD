    ...
    <main class="min-h-[90vh] mt-[10vh] p-10">
        <div class="bg-antiWhite p-10 rounded">
            ...
            <div class="pb-5 flex flex-row justify-end gap-3">
                <button data-modal-target="addCategory" data-modal-toggle="addCategory"
                    ...
                    <tbody>
                        <?php foreach ($categoryTable as $category) { ?>
                            <tr
                                ...
                                <td class="w-4 p-4">
                                    <div class="flex items-center">
                                        <input id="checkbox-table-search-1" type="checkbox" name="category"
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex justify-center gap-5">
                                        <div>
                                            <button data-modal-target="udapteModal_<?= $category['id_category'] ?>"
                                                data-modal-toggle="udapteModal_<?= $category['id_category'] ?>"
                                        ...
                                        <div>
                                            <button data-modal-target="alertDelete_<?= $category['id_category'] ?>"
                                                data-modal-toggle="alertDelete_<?= $category['id_category'] ?>"
                                                class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-1 text-center inline-flex items-center">
                                                Supprimer
                                            </button>
                                        </div>
                            ...
                            <div id="udapteModal_<?= $category['id_category'] ?>" tabindex="-1"
                                class="fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] md:h-full">
                                <div class="relative w-full h-full max-w-md md:h-auto">
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        <button type="button"
                                            class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white"
                                            data-modal-hide="udapteModal_<?= $category['id_category'] ?>">
                                        ...
                                        <div class="p-6 text-center">
                                            <h3 class="mb-5 text-xl font-bold text-gray-500">Modication de catégorie</h3>
                                            <form
                                                action="assets/src/back/updateCategory.php?id_category=<?= $category['id_category'] ?>"
                                                method="post">
                                                <div class="relative">
                                                    <input type="text" id="name_category" name="name_category" value="<?= $category['name_category'] ?>"
                                                ...
                                                <div class="p-6 text-center">
                                                    <button data-modal-hide="udapteModal_<?= $category['id_category'] ?>"
                                                        type="submit" name="updateCategory"
                            ...
                            <div id="alertDelete_<?= $category['id_category'] ?>" tabindex="-1"
                                class="fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] md:h-full">
                                <div class="relative w-full h-full max-w-md md:h-auto">
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        <button type="button"
                                            class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white"
                                            data-modal-hide="alertDelete_<?= $category['id_category'] ?>">
                                            <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd"
                                                    d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                                        ...
                                        <div class="p-6 text-center">
                                            ...
                                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Êtes-vous
                                                sûr de vouloir effacer la catégorie  : <span class="font-bold">
                                                    <?= $category['name_category'] ?>
                                                </span> ?</h3>
                                            <form action="assets/src/back/deleteCategory.php" method="post">
                                                <input type="hidden" name="id_category"
                                                    value="<?= $category['id_category'] ?>" />
                                                <button data-modal-hide="alertDelete_<?= $category['id_category'] ?>"
                                                    type="submit" name="deleteCategory"
        ...
        <div id="addCategory" tabindex="-1"
            ...
            <div class="relative w-full h-full max-w-md md:h-auto">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-6 text-center">
                        <h3 class="mb-5 text-xl font-bold text-gray-500">Ajout de catégorie</h3>
                        <form action="assets/src/back/addCategory.php" method="post">
                            <div class="relative">
                            ...
                            <div class="p-6 text-center">
                                <button data-modal-hide="addCategory" type="submit" name="addCategory"
