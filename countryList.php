...
<body class="bg-primary">
    ...
    <main class="min-h-[90vh] mt-[10vh] p-10">
        <div class="bg-antiWhite p-10 rounded">
            <div class="flex flex-col items-center">
                <h2 class="text-3xl font-bold">Liste des pays</h2>
                <?php require('assets/src/component/titleBar.php'); ?>
            </div>
            <div class="pb-5 flex flex-row justify-end gap-3">
                <button data-modal-target="addCountry" data-modal-toggle="addCountry"
                ...
                <button data-modal-target="deleteCountry" data-modal-toggle="deleteCountry"
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        <?php foreach ($countryTable as $country) { ?>
                            <tr
                                class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                <td class="w-4 p-4">
                                    <div class="flex items-center">
                                        <input id="checkbox-table-search-1" type="checkbox" name="country"
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex justify-center gap-5">
                                        <div>
                                            <button data-modal-target="udapteModal_<?= $country['id_country'] ?>"
                                                data-modal-toggle="udapteModal_<?= $country['id_country'] ?>"
                                        ...
                                        <div>
                                            <button data-modal-target="alertDelete_<?= $country['id_country'] ?>"
                                                data-modal-toggle="alertDelete_<?= $country['id_country'] ?>"
                                                class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-1 text-center inline-flex items-center">
                                                Supprimer
                                            </button>
                                        </div>
                            ...
                            <div id="udapteModal_<?= $country['id_country'] ?>" tabindex="-1"
                                class="fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] md:h-full">
                                <div class="relative w-full h-full max-w-md md:h-auto">
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        <button type="button"
                                            class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white"
                                            data-modal-hide="udapteModal_<?= $country['id_country'] ?>">
                                        ...
                                        <div class="p-6 text-center">
                                            <h3 class="mb-5 text-xl font-bold text-gray-500">Modication de pays</h3>
                                            <form
                                                action="assets/src/back/updateCountry.php?id_country=<?= $country['id_country'] ?>"
                                                method="post">
                                                <div class="relative">
                                                    <input type="text" id="name_country" name="name_country" value="<?= $country['name_country'] ?>"
                                                ...
                                                <div class="p-6 text-center">
                                                    <button data-modal-hide="udapteModal_<?= $country['id_country'] ?>"
                                                        type="submit" name="updateCountry"
                            ...
                            <div id="alertDelete_<?= $country['id_country'] ?>" tabindex="-1"
                                class="fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] md:h-full">
                                <div class="relative w-full h-full max-w-md md:h-auto">
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        <button type="button"
                                            class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white"
                                            data-modal-hide="alertDelete_<?= $country['id_country'] ?>">
                                            <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd"
                                                    d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                                        ...
                                        <div class="p-6 text-center">
                                            ...
                                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Êtes-vous
                                                sûr de vouloir effacer le pays : <span class="font-bold">
                                                    <?= $country['name_country'] ?>
                                                </span> ?</h3>
                                            <form action="assets/src/back/deleteCountry.php" method="post">
                                                <input type="hidden" name="id_country"
                                                    value="<?= $country['id_country'] ?>" />
                                                <button data-modal-hide="alertDelete_<?= $country['id_country'] ?>"
                                                    type="submit" name="deleteCountry"
    ...
    <aside>
        <div id="addCountry" tabindex="-1"
            class="fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] md:h-full">
            <div class="relative w-full h-full max-w-md md:h-auto">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    <button type="button"
                        class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white"
                        data-modal-hide="addCountry">
                        <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                                d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                    ...
                    <div class="p-6 text-center">
                        <h3 class="mb-5 text-xl font-bold text-gray-500">Ajout de pays</h3>
                        <form action="assets/src/back/addCountry.php" method="post">
                            <div class="relative">
                                <input type="text" id="name_country"name="name_country"
                                    class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-secondary peer"
                                    placeholder=" " />
                                <label for="name_country"
                            ...
                            <div class="p-6 text-center">
                                <button data-modal-hide="addCountry" type="submit" name="addCountry"
                                ...
                                <button data-modal-hide="addCountry" type="button"
                                    class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">Non,
                                    annuler</button>
                            </div>
                        </form>
